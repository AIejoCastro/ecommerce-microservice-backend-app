...
public class E2ESuite {
    ...
    static class Initializer implements ApplicationContextInitializer<ConfigurableApplicationContext> {
        ...
        public void initialize(ConfigurableApplicationContext context) {
            ...
            serviceDiscoveryContainer = new GenericContainer<>("alejocastro/service-discovery:dev")
                    .withNetwork(network)
            ...
            cloudConfigContainer = new GenericContainer<>("alejocastro/cloud-config:dev")
                    .withNetwork(network)
            ...
            userServiceContainer = new GenericContainer<>("alejocastro/user-service:dev")
                    .withNetwork(network)
            ...
            productServiceContainer = new GenericContainer<>("alejocastro/product-service:dev")
                    .withNetwork(network)
            ...
            orderServiceContainer = new GenericContainer<>("alejocastro/order-service:dev")
                    .withNetwork(network)
            ...
            paymentServiceContainer = new GenericContainer<>("alejocastro/payment-service:dev")
                    .withNetwork(network)
            ...
            favouriteServiceContainer = new GenericContainer<>("alejocastro/favourite-service:dev")
                    .withNetwork(network)
